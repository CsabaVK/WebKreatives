...
window.AD = {
  ...
  reviews: [
    { name: '', photo: 'assets/reviews/review-1.jpg', stars: 5, when: '', text: "Auto District is a great garage. I was helped right away. It's a VAG-specialized garage, but they took excellent care of my Mercedes-Benz. I'll definitely be back." },
    { name: '', photo: 'assets/reviews/review-2.jpg', stars: 5, when: '', text: "This garage offers excellent service and a friendly, professional approach. I wish Fatih continued success in his work." },
    { name: '', photo: 'assets/reviews/review-3.jpg', stars: 5, when: '', text: "Friendly and fast auto service. The price and the time was told before they started working on it as I asked them to. They speak also perfect English which makes it very much recommended for international as well. Car was done the same day and ready for pick up! Definitely can recommend, best service I ever went to!" },
    { name: '', photo: 'assets/reviews/review-4.jpg', stars: 5, when: '', text: "This morning I visited Auto District to have my parents' campervan checked out, and I was extremely impressed with the service. Despite the spontaneous appointment they were more than happy to help: I called the evening before and had a slot first thing in the morning. They got us in and out quickly and gave us fresh coffee while we waited. We will definitely be returning for other repairs." },
    { name: '', photo: 'assets/reviews/review-5.jpg', stars: 5, when: '', text: "Auto District is a true case of \"small but mighty.\" The guys are really knowledgeable, open and transparent. Another small detail: when I bring my child, they treat him well! I have complete confidence in having my car serviced here." }
  ]
};